...
module.exports = {
  ...
  //
  // Levels are on combined premium, off entry debit. Step == stop distance is deliberate:
  // it puts rung 1's stop exactly at breakeven, so the first ratchet makes the trade free.
  ...
  // OPTION_STOP_PCT exits - this must not quietly introduce a tighter entry-side stop than
  // what was validated. The ratchet can only ever tighten a trade that is already winning.

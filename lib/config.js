...
module.exports = {
  ...
  RISK_PCT_PER_TRADE: 0.05, // premium budget per trade = 5% of current equity
  MAX_CONCURRENT_POSITIONS: 4, // account-wide - raised from 2 on 2026-07-30 (deliberate human change, see risk-caps.lock.json). At 5%/trade this caps simultaneous commitment near 20% of equity.
  ...
  // never bound on the worst day it has seen is not a circuit breaker. At 5%/trade, 10% is
  // roughly "two full-size losers and stop for the day".
  DAILY_LOSS_STOP_PCT: 0.10, // stop entering after losing 10% of day-start equity
